...
//Cabecera: void pregunta(char *, int);
...
//Cabecera: void preguntar_contrasena(char *);
...
//Cabecera: void pregunta_localidad(Estr_Localidad *, int, char *);
...
//Cabecera: void pregunta_ruta(Estr_Localidad *, int, Estr_Rutas **, int, int, char *);
...
//Postcondicion: Introducir en una cadena, la localidad seleccionada de la lista, que este en una ruta.
...
//Cabecera: void preguntar_veh(Estr_Vehiculo *, int, char *, int *);
