...
void eliminar_viaje(int i)
{
    ...
    else
    {
        ...
        if(num_v>0&&encontrado2==0)
        {
            ...
            for(m=0; m<num_v; m++)
            {
                printf("%s-%s-%s-%s-%s-%s-%s-%s-%s\n", viaje[vec_viaje[m]].id_viaje, viaje[vec_viaje[m]].id_mat,viaje[vec_viaje[m]].id_mat,viaje[vec_viaje[m]].f_inic,viaje[vec_viaje[m]].h_inic,viaje[vec_viaje[m]].h_fin,viaje[vec_viaje[m]].plazas_libre,viaje[vec_viaje[m]].ida_vuelta,viaje[vec_viaje[m]].precio,viaje[vec_viaje[m]].estado);
            }
            num_v++;
            printf("(%i)Salir.\n", num_v);
